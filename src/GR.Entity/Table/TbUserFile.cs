...
namespace GR.entity {
	...
	/// 用户文件权限关联
		/// 
	/// </summary>
	[JsonObject(MemberSerialization.OptIn), Table(Name = "tb_user_file")]
	public partial class TbUserFile {
		...
		/// 文件id
		/// </summary>
		[JsonProperty, Column(Name = "file_id", DbType = "varchar(36)")]
		...
		/// 用户id
		/// </summary>
		[JsonProperty, Column(Name = "user_id", DbType = "varchar(36)")]
