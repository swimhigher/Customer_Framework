...
namespace GR.entity {
	...
	/// tb_directory
	/// </summary>
	[JsonObject(MemberSerialization.OptIn), Table(Name = "tb_directory")]
	public partial class TbDirectory {
		...
		/// 所有父目录
		/// </summary>
		[JsonProperty, Column(Name = "allparent", DbType = "varchar(1800)")]
		...
		/// 部门id
		/// </summary>
		[JsonProperty, Column(Name = "deptmentid", DbType = "varchar(36)")]
		public string Deptmentid { get; set; }

		/// <summary>
		/// 层级
		/// </summary>
		[JsonProperty, Column(Name = "floor")]
		...
		/// 父级id
		/// </summary>
		[JsonProperty, Column(Name = "parent", DbType = "varchar(36)")]
