...
namespace GR.Entity {
	...
	[JsonObject(MemberSerialization.OptIn), Table(Name = "sys_role_menu")]
	public partial class SysRoleMenu {
		...
		[JsonProperty, Column(Name = "Menu_Id", DbType = "varchar(40)")]
		public string MenuId { get; set; }

		[JsonProperty, Column(Name = "Power_Id", DbType = "varchar(40)")]
