...
(function (factory) {
    ...
    */
    ...
    $.validator.addMethod("contactPhone", function (value, element) {
        var length = value.length;
        var tt = /^[-0-9]+$/;
        return this.optional(element) || (length <= 20 && tt.test(value));
    }, "请输入正确联系方式");
    ...
    $.validator.addMethod("expressname", function (value, element) {
        var name = /^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,20}$/;
        return this.optional(element) || name.test(value);
    }, "请输入字母加数字的字符");
    jQuery.validator.addMethod("minnum", function (value, element) {
        return this.optional(element) || value >= 18;
    }, $.validator.format("请输入不小于 18 的数值 "));
    jQuery.validator.addMethod("minzero", function (value, element) {
    ...
    }, $.validator.format("请输入不大于 100 的数值 "));
...
$.extend($.validator.messages, {
    ...
    minWords: $.validator.format("请输入不小于 {0} 的数值"),
});